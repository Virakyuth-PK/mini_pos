...
class XSearchBarAnimation extends StatefulWidget {
  ...
  XSearchBarAnimation({
    ...
    this.cursorColour = CompanyColor.CHIPMONG_RETAIL,
    this.hintTextColour = Colors.black12,
    this.searchBoxBorderColour = Colors.black12,
    this.buttonShadowColour = Colors.transparent,
  ...
  @override
  _XSearchBarAnimationState createState() => _XSearchBarAnimationState();
}

class _XSearchBarAnimationState extends State<XSearchBarAnimation>
      ...
      child: Container(
        decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.circular(
            _isAnimationOn ? Dimensions.d20 : Dimensions.d0,
          ),
            ...
            children: [
              AnimatedPositioned(
                ...
                child: AnimatedOpacity(
                  opacity: (!widget.switcher) ? Dimensions.d0 : Dimensions.d1,
  ...
  void _onTapFunction() {
    _isAnimationOn = true;
    widget.onPressButton?.call(!widget.switcher);
    setState(() {
      if (!widget.switcher) {
